...
CREATE TABLE IF NOT EXISTS {TimeTable} (
    ...
    public async Task<bool> CheckIfTableExistsAsync()
    {
        ...
        Console.WriteLine($"Table {TimeTable} exists: {tableExists}");
        return tableExists;
    }
    ...
    public WorkTime GetRandomWorkTime()
    {
        ...
        int randomTime = Random.Shared.Next(1,20);
        return new WorkTime() { Title = $"Random {randomTime} minute ;)", StartTime = start, EndTime = (start + TimeSpan.FromMinutes(randomTime)) };
    }
